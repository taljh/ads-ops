...
> **القواعد عامة، والأرقام per-client.** الأرقام أدناه = **مثال عميلة زين**؛ الأرقام الفعلية لكل عميل في `clients/<client>/benchmarks.md`. **ممنوع نسخ أرقام عميل لآخر** (راجع `faza3/system-improvement.md §0`). التفاصيل المنهجية في `faza3/playbook.md §7`.
